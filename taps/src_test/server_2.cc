...
char port_connect_self[] = "17000"; // starting port used to connect to client
char port_connect_2_controller[] = "16990";//port used to connect to SDN controller

char port_connect_dst[]  = "9000";

char port_controller[] = "5000"; //controller's listening port
char port_listen_self[] = "8000"; // the server self's listen port
...
//	srand((unsigned)time(NULL));
	...
	encaps_request_packet(request_pkt, 2, REQUEST); // 2 stand for server 2	
